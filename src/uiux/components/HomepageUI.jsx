...
import "../assets/HomepageUI.css";
import CustomScrollbarUI from "./CustomScrollbarUI";
import ContactUI from "./ContactUI";
import ProjectCardUI from "./ProjectCardUI";
import Dropdown from "./TeamUI";

import harry from "../assets/uiux1/projects/harry potter prototype.gif";
import food from "../assets/uiux1/projects/JUICY CAN SPIN.gif";
import School from "../assets/uiux1/projects/School Webpage.png";
import headphone from "../assets/uiux1/projects/pinterest app prototype.gif";
import landing from "../assets/uiux1/projects/Landing page.png";
import nike from "../assets/uiux1/projects/NIKE WEBSITE.png";
import travel from "../assets/uiux1/projects/Animation.gif";
import flow from "../assets/uiux1/projects/Flow 1@512p-25fps (14).gif";
    ...
    <div className="homepage">
      ...
      <section id="about" className="about">
        <div className="about-content">
          ...
          <p>
            At Nexura.UI, our UI/UX team is on a mission to make users fall in
            love at first click. We obsess over the little things—like
            pixel-perfect spacing, buttery-smooth buttons, and layouts that just
            feel right. If it looks clean and works like magic, you can bet we
            had something to do with it.
          </p>
          <p>
            But don’t let the pretty pixels fool you—we’re problem solvers at
            heart. We design with brains and style, crafting experiences that
            are as functional as they are fabulous. Whether it’s a sleek web app
            or a snappy mobile UI, we make sure every swipe, tap, and scroll
      ...
      <section id="open-source" className="services">
        ...
        <div className="services-container">
          <div className="service-card">
            <h3>Versatile Design Expertise</h3>
            <p>
              Covers a wide range of design solutions including websites, mobile
              apps, posters, and promotional banners.
            </p>
          </div>
          <div className="service-card">
            <h3>Bold Visual Storytelling</h3>
            <p>
              Focuses on impactful visuals with strong typography, dark themes,
              and modern design elements.
            </p>
          </div>
          <div className="service-card">
            <h3>Thematic Creativity</h3>
            <p>
              Incorporates unique design styles such as torn paper effects,
              futuristic layouts, and theme-based compositions.
            </p>
          </div>
          <div className="service-card">
            <h3>User-Centered Approach</h3>
            <p>
              Prioritizes usability and aesthetics to ensure designs are both
          ...
          <div className="footer-content">
            ...
            <div className="footer-links">
              ...
              <div className="footer-section">
                ...
                <ul>
                  <li>
                    <a href="https://versal-nexura.vercel.app/">
                      Main Website
                    </a>
                  </li>
                  <li>
