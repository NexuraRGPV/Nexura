...
import "../assets/HomepagePM.css";
import CustomScrollbarPM from "./CustomScrollbarPM";
import ContactPM from "./ContactPM";
import project1 from "../assets/para1/projects/project1.png";
import project2 from "../assets/para1/projects/project2.png";
import project3 from "../assets/para1/projects/project3.png";
import project4 from "../assets/para1/projects/project4.jpg";
import ProjectCardPM from "./ProjectCardPM";
...
const HomepagePM = () => {
  ...
  return (
    <div className="homepage">
      ...
      {/* Hero Section */}
      <section id="home" className="heropm">
        <div
                    ...
                    <div className="progress-bar">
                      <div
                        ...
                        style={{
                          width: `${progress}%`,
                          transition:
                            progress === 0 ? "none" : "width 1s ease-in-out",
                        }}
                      ></div>
                    </div>
      ...
      <section id="about" className="about">
        <div className="about-content">
          ...
          <p>
            Design is where ideas take visual form. Our designers are the
            storytellers of the club, crafting interfaces, posters, brand
            identities, and experiences that resonate. From pixel-perfect UI/UX
            for apps to bold event posters and social media creatives — they
            bring clarity and emotion to every project.
          </p>
          <p>
            Collaboration is at the heart of what they do. Whether it’s teaming
            up with developers for seamless user flows or working with the PR
            team for eye-catching promotions, designers make sure every piece
            not only looks great but feels right. They blend creativity with
            purpose to make the club’s vision truly visible.
          </p>
        </div>
      ...
      <section id="open-source" className="services">
        ...
        <div className="services-container">
          <div className="service-card">
            <h3>Parametric CAD Modeling</h3>
            <p>
              Advanced CAD modeling of mechanical and automotive components
              using SolidWorks with parametric precision.
            </p>
          </div>
          <div className="service-card">
            <h3>ANSYS Design Validation</h3>
            <p>
              Simulation-driven design validation using ANSYS for stress,
              thermal, and motion analysis.
            </p>
          </div>
          <div className="service-card">
            <h3>Simulation-Based Optimization</h3>
            <p>
              Iterative design optimization, integrating simulation feedback to
              improve performance and efficiency.
            </p>
          </div>
          <div className="service-card">
            <h3>Virtual Prototyping Integration</h3>
            <p>
              Bridging design and engineering, enabling virtual testing and
              rapid prototyping before physical production.
            </p>
          </div>
        </div>
      </section>
