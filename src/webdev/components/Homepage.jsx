...
// Videos (inside assets/webdev1/projects)
import project1Video from "../assets/webdev1/projects/project1.mp4";
import project2Video from "../assets/webdev1/projects/project2.mp4";
import project3Video from "../assets/webdev1/projects/project3.mp4";

// Thumbnails (inside assets/webdev1/projectThumbnails)
import project1thumbnail from "../assets/webdev1/projectThumbnails/project1.png";
import project2thumbnail from "../assets/webdev1/projectThumbnails/project2.png";
import project3thumbnail from "../assets/webdev1/projectThumbnails/project3.png";
...
const Homepage = () => {
  ...
  return (
    <div className="homepage">
      ...
      {/* Hero Section */}
      <section id="home" className="zero">
        <div
